# Linux Connectivity Issue Lab - Variables
# Variables for the connectivity troubleshooting scenario

variable "lab_scenario" {
  description = "Lab scenario name to trigger specific behaviors"
  type        = string
  default     = "Linux_Connectivity_Issue_01"
}
